...
#ifndef _AMALTHEA_FORWARD_HPP
#define _AMALTHEA_FORWARD_HPP

#include <ecorecpp/mapping_forward.hpp>

/*PROTECTED REGION ID(amalthea_forward) START*/
...
// EDataType
    /*PROTECTED REGION ID(amalthea_Address) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
    typedef int Address;
    /*PROTECTED REGION END*/
    /*PROTECTED REGION ID(amalthea_PositiveInt) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
    typedef int PositiveInt;
    /*PROTECTED REGION END*/
    /*PROTECTED REGION ID(amalthea_PositiveLong) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
    typedef int PositiveLong;
    /*PROTECTED REGION END*/
    /*PROTECTED REGION ID(amalthea_PositiveDouble) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
    typedef int PositiveDouble;
    /*PROTECTED REGION END*/
    /*PROTECTED REGION ID(amalthea_NonNegativeInt) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
    typedef int NonNegativeInt;
    /*PROTECTED REGION END*/
    /*PROTECTED REGION ID(amalthea_NonNegativeLong) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
    typedef int NonNegativeLong;
    /*PROTECTED REGION END*/
    /*PROTECTED REGION ID(amalthea_NonNegativeDouble) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
    typedef int NonNegativeDouble;
    /*PROTECTED REGION END*/
...
// Package & Factory
    class AmaltheaFactory;
    using AmaltheaFactory_ptr = ::ecore::Ptr<AmaltheaFactory>;
    class AmaltheaPackage;
    using AmaltheaPackage_ptr = ::ecore::Ptr<AmaltheaPackage>;

} // amalthea

#endif // _AMALTHEA_FORWARD_HPP
