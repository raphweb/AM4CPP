...
/*
 * amalthea/ModeValueCondition.cpp
...
/*PROTECTED REGION ID(ModeValueCondition.cpp) START*/
...
// Default constructor
ModeValueCondition::ModeValueCondition()
{

    /*PROTECTED REGION ID(ModeValueConditionImpl__ModeValueConditionImpl) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
