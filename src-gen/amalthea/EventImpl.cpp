        ...
        ::ecore::EBoolean _resolve)
{
    ...
    throw std::runtime_error("Event::eGet Error. FeatureID:" + _featureID);
}
        ...
        ::ecore::EJavaObject const &_newValue)
{
    ...
    throw std::runtime_error("Event::eSet Error. FeatureID:" + _featureID);
}
...
::ecore::EBoolean Event::eIsSet(::ecore::EInt _featureID)
{
    ...
    throw std::runtime_error("Event::eIsSet Error. FeatureID:" + _featureID);
}
...
void Event::eUnset(::ecore::EInt _featureID)
{
    ...
    throw std::runtime_error("Event::eUnset Error. FeatureID:" + _featureID);
}

::ecore::EClass_ptr Event::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::amalthea::AmaltheaPackage* >(::amalthea::AmaltheaPackage::_instance().get())->getEvent();
    return _eclass;
}
