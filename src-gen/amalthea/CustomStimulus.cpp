...
/*PROTECTED REGION ID(CustomStimulus.cpp) START*/
...
// Default constructor
CustomStimulus::CustomStimulus()
{

    /*PROTECTED REGION ID(CustomStimulusImpl__CustomStimulusImpl) START*/
// Please, enable the protected region if you add manually written code.
// To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
