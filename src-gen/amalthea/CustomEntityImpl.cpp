...
/*PROTECTED REGION ID(CustomEntityImpl.cpp) START*/
...
void CustomEntity::_initialize()
{
    ...
    /*PROTECTED REGION ID(CustomEntityImpl__initialize) START*/
    // Please, enable the protected region if you add manually written code.
    // To do this, add the keyword ENABLED before START.
    /*PROTECTED REGION END*/
}
...
// EObject
::ecore::EJavaObject CustomEntity::eGet(::ecore::EInt _featureID,
        ::ecore::EBoolean _resolve)
{
    ...
    case ::amalthea::AmaltheaPackage::CUSTOMENTITY__TYPENAME:
    {
    ...
    throw std::runtime_error(
            "CustomEntity::eGet Error. FeatureID:" + _featureID);
}

void CustomEntity::eSet(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    ...
    case ::amalthea::AmaltheaPackage::CUSTOMENTITY__TYPENAME:
    {
        ...
        ::amalthea::CustomEntity::setTypeName(_t0);
        return;
    }
    }
    throw std::runtime_error(
            "CustomEntity::eSet Error. FeatureID:" + _featureID);
}

::ecore::EBoolean CustomEntity::eIsSet(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    case ::amalthea::AmaltheaPackage::IANNOTATABLE__CUSTOMPROPERTIES:
    ...
    throw std::runtime_error(
            "CustomEntity::eIsSet Error. FeatureID:" + _featureID);
}

void CustomEntity::eUnset(::ecore::EInt _featureID)
{
    switch (_featureID)
    {
    ...
    throw std::runtime_error(
            "CustomEntity::eUnset Error. FeatureID:" + _featureID);
}

::ecore::EClass_ptr CustomEntity::_eClass()
{
    static ::ecore::EClass_ptr _eclass =
            dynamic_cast< ::amalthea::AmaltheaPackage* >(::amalthea::AmaltheaPackage::_instance().get())->getCustomEntity();
    return _eclass;
}

/** Set the local end of a reference with an EOpposite property.
 */
void CustomEntity::_inverseAdd(::ecore::EInt _featureID,
        ::ecore::EJavaObject const &_newValue)
{
    switch (_featureID)
    {
 ...
 */
void CustomEntity::_inverseRemove(::ecore::EInt _featureID,
